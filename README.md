...
Метод currentLocalDescription возвращает копию текущего согласованного локального описания, т.е. локальное описание последнего успешного запрос\ответ SDP-обмена, плюс все локальномые кандидаты, которые были сгенерированы ICE-агентом после установки локальной сессии.
